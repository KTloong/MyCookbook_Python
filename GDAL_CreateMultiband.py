...
outfile = driver.Create("D:\\Desktop\\新分离三波段\\b\\b_collection.tif", xy[0], xy[1], len(bandList), gdal.GDT_Byte)#specify output name, col number, row number,band number and pixeltype
